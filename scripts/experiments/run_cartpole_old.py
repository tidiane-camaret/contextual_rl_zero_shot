...
if __name__ == "__main__":
    ...
    parser.add_argument('--nb_steps', type=int, default=200_000)
    ...
    train_env = vec_env.DummyVecEnv([
        ...
        RecordEpisodeStatistics(CartPoleEnv(eval_mode=False, oracle=oracle)),
        )
    ...
    scale_list = np.linspace(0.1, 1, 10) + 0.05
    ...
    for s, scale in enumerate(scale_list):
        eval_env = CartPoleEnv(eval_mode=True, oracle=oracle, length=scale)
