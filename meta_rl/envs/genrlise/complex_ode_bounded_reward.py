from meta_rl.envs.genrlise.utils.types import Action, State

from meta_rl.envs.genrlise.complex_ode import ComplexODE
...
class ComplexODEBoundedReward(ComplexODE):
    ...
    def _get_reward(
        self, state: State, action: Action, next_state: State, done: bool
    ) -> float:
        s = abs(next_state)
